...
const CryptoState = (prop) => {
  const host = "crypto-hub-backend.vercel.app";
  ...
  return (
    <CryptoContext.Provider value={{alert, showAlert, symbol, currency, setCurrency, setSymbol, setUserName, userName, getCoins, addCoin, deleteCoin, coins, watchlist, setWatchList, login, setLogin}}>
        {prop.children}
