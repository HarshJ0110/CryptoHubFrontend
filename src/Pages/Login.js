...
const Login = () => {
  ...
  const {setUserName, setLogin, showAlert, alert} = context;
        ...
        <div className="md:max-w-3xl md:max-h-xl md:mx-auto md:flex md:items-center md:rounded-3xl md:shadow-2xl">
          ...
          <div className='w-screen p-10 mt-12 md:m-5 md:p-0 md:mr-0 md:w-80 text-blue-400'>
            <form onSubmit={handlesubmit}>
              ...
              <button className='w-full p-2 mt-3 border hover:bg-blue-400 border-blue-400 hover:text-black rounded-md'><Link to="/signup">SignUp</Link></button>
            </form>
          </div>
        </div>
      </div>
