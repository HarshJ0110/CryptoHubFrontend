    ...
    <div className='mt-20 md:mt-32 flex flex-col'>
      ...
      <div className="flex flex-row justify-around flex-wrap mt-10">
        {searchedCoin.slice(startIndex, endIndex).map((coin) => {
          return (
            <Coin key={coin.id} id={coin.id} name={coin.name} image={coin.image} coinSymbol={coin.symbol} price_change_percentage_24h={coin.price_change_percentage_24h} current_price={coin.current_price} />
          )
        })}
      </div>
      <div className='m-auto mb-20'>
        <button className='text-white m-3'
          ...
          onClick={handleClick}
        >
          <i style={{ color: 'white' }} className="fa-solid fa-chevron-left fa-2xl"></i>
        </button>
        <button className='text-white m-3'
        ...
        >
          <i style={{ color: 'white' }} className="fa-solid fa-chevron-right fa-2xl"></i>
        </button>
      </div>
    </div>
  )
